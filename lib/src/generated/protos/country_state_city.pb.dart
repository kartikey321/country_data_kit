...
class State extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'State', createEmptyInstance: create)
    ...
    ..aOS(5, _omitFieldNames ? '' : 'countryName')
    ..aOS(6, _omitFieldNames ? '' : 'wikiDataId', protoName: 'wikiDataId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.String get wikiDataId => $_getSZ(5);
  @$pb.TagNumber(6)
  set wikiDataId($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasWikiDataId() => $_has(5);
  @$pb.TagNumber(6)
  void clearWikiDataId() => clearField(6);
}
...
class City extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'City', createEmptyInstance: create)
    ...
    ..a<$core.int>(5, _omitFieldNames ? '' : 'countryId', $pb.PbFieldType.O3)
    ..aOS(6, _omitFieldNames ? '' : 'countryName')
    ..aOS(7, _omitFieldNames ? '' : 'latitude')
    ..aOS(8, _omitFieldNames ? '' : 'longitude')
    ..aOS(9, _omitFieldNames ? '' : 'wikiDataId', protoName: 'wikiDataId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $core.String get latitude => $_getSZ(6);
  @$pb.TagNumber(7)
  set latitude($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  $core.String get longitude => $_getSZ(7);
  @$pb.TagNumber(8)
  set longitude($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set wikiDataId($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasWikiDataId() => $_has(8);
  @$pb.TagNumber(9)
  void clearWikiDataId() => clearField(9);
}
